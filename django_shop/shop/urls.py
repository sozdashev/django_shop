...
urlpatterns = [
    ...
    path('products/<int:product_id>/delete', Product_Delete.as_view(),
    ...
    path('profile/cart/ordered', ordered_list, name='cart_order_url'),
    path('profile/cart/<str:order_code>', read_ordered, name='order_url'),
